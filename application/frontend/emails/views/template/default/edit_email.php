...
<div class="bs-docs-container">
	<a class="lead" id="desplegar-form">Edición de Email</a>
	...
	<form method="post" action="<?php echo $url_action; ?>" enctype="multipart/form-data" role="form" autocomplete="off" id="my-form" class="bs-docs-container" >
		<div id="home">
			<div class="form-group">
				<label for="nombre">Nombre del Mail</label>
				<input type="email" class="form-control custom-input-lg" name="nombre_email" id="marca" placeholder="Ingrese el nombre del email" value="<?php echo $email['nombre_email']?>">
			</div>
