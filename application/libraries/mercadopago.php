...
class Mercadopago {
    ...
    function __construct($datos_iniciales = NULL)
    {
        $this->client_id        = $datos_iniciales['CLIENT_ID'];
        $this->client_secret = $datos_iniciales['CLIENT_SECRET'];
    }
    ...
    public function get_payment($id) {
        ...
        log_message('error', 'llego linea 65');
...
class MPRestClient {
    ...
    private static function get_connect($uri, $method, $content_type) {
        ...
        log_message('error', 'estoy linea 253. uri: ' . $uri);
