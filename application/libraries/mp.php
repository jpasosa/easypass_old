...
class Mp {
    ...
    public function get_access_token() {
        ...
        //
        echo ' <br/> <div style="font-weight: bold; color: green;"> $access_data: </div> <pre>' ;
    ...
    */
    ...
    public function create_preference($preference) {
        ...
        // Debagueo un objeto / arreglo / variable
        //
        echo ' <br/> <div style="font-weight: bold; color: green;"> $access_token: </div> <pre>' ;
        echo '<div style="color: #3741c6;">';
...
class MPRestClient {
    ...
    private static function exec($method, $uri, $data, $content_type)
    {
        ...
        // Debagueo un objeto / arreglo / variable
        //
        echo ' <br/> <div style="font-weight: bold; color: green;"> $connect: </div> <pre>' ;
        echo '<div style="color: #3741c6;">';
        if(is_array($connect)) {
            print_r($connect);
        }else {
